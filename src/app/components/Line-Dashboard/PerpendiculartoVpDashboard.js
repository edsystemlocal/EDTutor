...
import { ParalleltobothValidation, PerpendiculartoVpValidation } from "../Helper/validationHelper";


export default function PerpendiculartoVpDashboard({ drawingType  , themeSelect }) {
