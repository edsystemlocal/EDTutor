...
export default function ParalleltobothDashboard({ drawingType, themeSelect }) {
  ...
  const inputStyle =
    "w-12 p-2 m-1 text-gray-700 border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400  bg-gradient-to-r from-green-100 to-blue-100";
  const buttonStyle =
