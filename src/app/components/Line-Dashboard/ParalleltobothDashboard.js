...
export default function ParalleltobothDashboard({ drawingType,themeSelect  }) {
  ...
  return (
    <div className="flex flex-col w-full bg-gradient-to-b from-blue-50 to-white min-h-screen top-5">
      {/* <header className="p-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-center text-2xl font-bold shadow-lg">
        Drawing Dashboard
      </header> */}
              ...
              <div>
                {[
                  { label: "Line Length", value: LineLength, setter: setLineLength },
                  {
                    ...
                    setter: setFirstPointFrontOfVPLength,
                  },
                  {
                    label: "First Point Above HP Length",
