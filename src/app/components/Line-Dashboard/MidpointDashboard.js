...
export default function MidpointDashboard({ drawingType }) {
  ...
  const [showInfo13, setShowInfo13] = useState(false);
  ...
  const showInfoRef12 = useRef(null);
  const showInfoRef13 = useRef(null);
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (showInfoRef12.current && !showInfoRef12.current.contains(event.target)) {
        setShowInfo12(false);
      }
      if (showInfoRef13.current && !showInfoRef13.current.contains(event.target)) {
        setShowInfo13(false);
      }
    };
              ...
              <table className="w-full text-left text-gray-700">
                <tbody>
                  ...
                  <tr>
                    <td className="p-2">
                      <span className={labelStyle}>
                        Mid Point of HP Length:
                        <span
                          className={infoIconStyle}
                          title={HoverMsg}
                          onClick={() => setShowInfo12(!showInfo12)} // toggle tooltip on click
                        >
                          ⓘ
                        </span>
                      </span>
                  ...
                  <tr>
                    <td className="p-2">
                      <span className={labelStyle}>
                        Mid Point of VP Length:
                        <span
                          className={infoIconStyle}
                          title={HoverMsg}
                          onClick={() => setShowInfo13(!showInfo13)} // toggle tooltip on click
                        >
                          ⓘ
                        </span>
                      </span>
