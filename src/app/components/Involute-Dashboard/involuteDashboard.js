...
export default function InvoluteDashboard({ drawingType }) {
  ...
  const [TypeOfInvolute, setTypeOfInvolute] = useState("Circle");


  const inputs = {
    "Diameter" :Diameter,
    "Type Of Involute": TypeOfInvolute,
  };
                ...
                <div>
                  <table className="table-auto w-full">
                    <tbody>
                      ...
                      <td>
                      <select
                        value={TypeOfInvolute}
                        onChange={(e) => setTypeOfInvolute(e.target.value)}
                        className={selectInputStyle}
                      >
                        <option value="Above">Circle</option>
                      </select>
                    </td>
                    </tr>
                    <tr>
